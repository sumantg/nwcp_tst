...
public class ProxyServlet extends HttpServlet {
    ...
    private HttpClient setSecuredHttpClient(HttpClient httpClient) throws Exception {
        ...
        try {
                         ...
                         SchemeRegistry sr = ccm.getSchemeRegistry();
                         int sz = sr.getSchemeNames().size();
                    	 LOGGER.debug("setSecuredHttpClient: Schemes Count:" + new Integer(sz).toString());
...
//			LOGGER.debug("setSecuredHttpClient: Exception thrown:" + e.getMessage()  );
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException,
		...
		try {
			...
			httpClient = setSecuredHttpClient(httpClient);
